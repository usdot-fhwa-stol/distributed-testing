...
buildGeneralImage="harbor.distributedtesting.org/dot-ostr-dt/dt-build-general:0.2.0"
buildCarlaImage="harbor.distributedtesting.org/dot-ostr-dt/dt-build-carla:latest"
