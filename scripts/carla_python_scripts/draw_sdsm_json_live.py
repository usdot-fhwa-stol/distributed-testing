...
def get_georeference_from_local_xodr(map_name="Town10HD_Opt"):
    """
    Reads the georeference string directly from the cached .xodr file in CARLA 0.10.0.
    """
...
def main() -> None:
    ...
    try:
        ...
        while True:
            ...
            # SAE J2735 MessageFrame ID for SDSM is expected to begin with 0029
            # in this adapter's encoded payload format.
