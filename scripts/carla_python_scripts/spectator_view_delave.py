...
"""Set or inspect the spectator camera view for Delave in CARLA."""
...
DEFAULT_LOCATION = carla.Location(x=-105.437805, y=726.073425, z=926.507080)
DEFAULT_ROTATION = carla.Rotation(pitch=-89.0, yaw=-90.0, roll=0.0)
