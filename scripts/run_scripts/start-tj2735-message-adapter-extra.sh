...
$localadapterPath/bin/tena-j2735-message-adapter $useBestEffort -emEndpoints $VUG_EM_ADDRESS:$VUG_EM_PORT -listenEndpoints $VUG_LOCAL_ADDRESS -adapterSendEndpoint $VUG_J2735_ADAPTER_SEND_ADDRESS:5397 -adapterReceiveEndpoint $VUG_J2735_ADAPTER_RECEIVE_ADDRESS:56699 -verbosity $adapterVerbosity | tee -a $adapterLogFile
