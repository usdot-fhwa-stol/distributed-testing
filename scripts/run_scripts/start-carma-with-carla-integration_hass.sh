...
$VUG_LOCAL_VOICES_POC_PATH/scripts/docker_scripts/stop_all_vehicles.sh &> /dev/null &
...
$VUG_LOCAL_VOICES_POC_PATH/scripts/run_scripts/pilot2/src/start-carma-carla-integration_hass.sh
