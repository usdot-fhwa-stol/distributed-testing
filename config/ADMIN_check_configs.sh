...
function print_help {
	echo
	echo "usage: ADMIN_check_configs.sh [--debug] [--verbose] [--help]"
	echo
	echo "Validate your config against the default"
	echo
...
check_configs $site_config_folder $default_site_config "$HOME/.dt_site_config"
